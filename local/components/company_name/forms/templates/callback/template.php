...
<div class="box__popup" data-callback>
        ...
        <div class="wrapper-content">
            ...
            <div class="row">
                <div class="col-12 col-xl-6">
                    <div class="box__form">
                        <form method="post" action="<?= $this->GetFolder() ?>/ajax.php" name="callback">
                            <div class="row">
                                <div class="col-12"><h2><?= \Bitrix\Main\Localization\Loc::getMessage('CALL_TITLE');?></h2></div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <? $APPLICATION->IncludeComponent(
