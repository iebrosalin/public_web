...
<div class="span9">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="category/<?php echo $product['category_id']; ?>"><?php echo(Category::getCategoryById($product['category_id'])['name']); ?>
            ...
            <div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                    <div class="item active">
                        <?php $PATHGALLERY = "/upload/images/gallery/" . $product['id'] . "/";
                        foreach ($productImages as $productIm): ?>
                            <a href="<?php echo($PATHGALLERY . $productIm['image']); ?>">
                                <img style="width:80px;"
                                     src="<?php echo($PATHGALLERY . $productIm['image']); ?>"
                                     alt=""/>
                            </a>
                        <?php endforeach; ?>
                    </div>
            ...
            <form class="form-horizontal qtyFrm">
                <div class="control-group">
                    <div class="controls" style="margin-left: 0">
                        <button type="submit" class="btn btn-large btn-primary add-to-cart"
                                data-id="<?php echo $product['id']; ?>" style="position:relative; flow:left"> Add to
                            cart <i class=" icon-shopping-cart" style="margin-top: 5px"></i></button>
                        <p class="control-label" style=" margin: 1% -8% 0px 0px; text-align: left">
                            <span><?php echo "Price: " . $product['price'] . " $"; ?></span></p>
                    </div>
                </div>
            </form>
            <hr class="soft clr"/>
                ...
                <div class="row" style="margin-left: 0;">
                    <form action="#" method="post" class="form-contact-alt">
                        ...
                        <div class="form-group">
                            ...
                            <?php endif; ?>
                            <textarea cols="40" rows="5" class="form-control" name="message"
                                      style="resize: none; width: 300px;"><?php echo $message; ?></textarea>
                        </div>
                        <?php if ($guest): ?>
